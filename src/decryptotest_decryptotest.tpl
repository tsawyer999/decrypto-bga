...
<script type="text/javascript">
    ...
    let jstpl_guess_selector_item = '<div id="guess_selector_item_${hintIndex}_${selectorIndex}" class="guess-selector-item" data-selector-index="${selectorIndex}">${selectorIndex}</div>';
